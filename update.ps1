...
& $pythonCmd -m pip install pdf2docx python-docx PyMuPDF openai pywin32 pytesseract aiohttp pillow python-dotenv google-genai aiogram SpeechRecognition pydub 2>$null
